const CACHE_NAME='supermac-pwa-v1';
const FILES=['./','./index.html','./style.css','./script.js','./manifest.json','./assets/logo.png','./assets/app-icon.png','./assets/machine-hero.jpg','./assets/brochure.pdf','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
